...
public class MediaTekRIL extends RIL implements CommandsInterface {
    ...
    static final int RIL_REQUEST_SIM_OPEN_CHANNEL_WITH_SW = (RIL_REQUEST_MTK_BASE + 74); // NFC
                                                                                         // SEEK
    ...
    // Engle, add define for MTK, start
    static final int RIL_REQUEST_SWITCH_HOLDING_AND_ACTIVE = 15;
    static final int RIL_REQUEST_GSM_GET_BROADCAST_SMS_CONFIG = 89;
    static final int RIL_REQUEST_GSM_SET_BROADCAST_SMS_CONFIG = 90;
    static final int RIL_REQUEST_GSM_SMS_BROADCAST_ACTIVATION = 91;
    static final int RIL_REQUEST_CDMA_GET_BROADCAST_SMS_CONFIG = 92;
    static final int RIL_REQUEST_CDMA_SET_BROADCAST_SMS_CONFIG = 93;
    static final int RIL_REQUEST_CDMA_SMS_BROADCAST_ACTIVATION = 94;
    // Engle, add define for MTK, end
    ...
    protected void processUnsolicited(Parcel p) {
        ...
        switch (response) {
            ...
            case RIL_UNSOL_NEIGHBORING_CELL_INFO:
                ret = responseStrings(p);
                break;
            case RIL_UNSOL_NETWORK_INFO:// Engle,responseVoid
                ret = responseStrings(p);
                break;
        ...
        switch (response) {
            ...
            case RIL_UNSOL_NITZ_TIME_RECEIVED:
                ...
                // has bonus long containing milliseconds since boot that the
                // NITZ
                // time was received
            ...
            case RIL_UNSOL_SMS_READY_NOTIFICATION:
                /*
                 * if (mGsmSmsRegistrant != null) { mGsmSmsRegistrant
                 * .notifyRegistrant(); }
                 */
                break;
            case RIL_UNSOL_RESPONSE_RADIO_STATE_CHANGED:
                // intercept and send GPRS_TRANSFER_TYPE and GPRS_CONNECT_TYPE
                // to
                // RIL
                ...
                break;
            default:
                Rlog.i(LOG_TAG, "Unprocessed unsolicited known MTK response: "
                        + response);
        }
